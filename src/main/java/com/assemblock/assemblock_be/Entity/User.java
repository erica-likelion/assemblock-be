...
public class User {
    ...
    private Set<com.assemblock.assemblock_be.Entity.MemberRole> mainRoles = new HashSet<>();
    ...
    public void updateProfile(String newNickname, String newPortfolioUrl, String newIntroduction,
                              Set<com.assemblock.assemblock_be.Entity.MemberRole> newMainRoles, ProfileType newProfileType, String newPortfolioPdfUrl) {
    ...
    @Converter
    public static class MemberRoleSetConverter implements AttributeConverter<Set<com.assemblock.assemblock_be.Entity.MemberRole>, String> {
        @Override
        public String convertToDatabaseColumn(Set<com.assemblock.assemblock_be.Entity.MemberRole> attribute) {
            if (attribute == null || attribute.isEmpty()) {
                return "";
            }
            return attribute.stream()
                    .map(com.assemblock.assemblock_be.Entity.MemberRole::name)
                    .collect(Collectors.joining(","));
        }

        @Override
        public Set<com.assemblock.assemblock_be.Entity.MemberRole> convertToEntityAttribute(String dbData) {
            if (dbData == null || dbData.isBlank()) {
                return new HashSet<>();
            }
            return Arrays.stream(dbData.split(","))
                    .map(com.assemblock.assemblock_be.Entity.MemberRole::valueOf)
